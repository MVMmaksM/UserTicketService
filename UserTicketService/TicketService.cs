...
namespace UserTicketService
{
    public class TicketService : ITicketService
    {
        ...
        public void SaveTicket(Ticket ticket) => FakeBaseData.Add(ticket);

        public void DeleteTicket(Ticket ticket) => FakeBaseData.Remove(ticket);

        public IEnumerable<Ticket> GetAllTickets() => FakeBaseData;
    }
}
